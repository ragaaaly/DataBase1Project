...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            Thesis Id&nbsp;
            <asp:TextBox ID="thesisid" runat="server" Height="16px" style="margin-right: 35px" Width="117px"></asp:TextBox>
            <br />
            <br />
            Defense date
            <br />
            ...
            <br />
            Comments :<br />
            <asp:TextBox ID="commentbox" runat="server" Height="72px" Width="855px"></asp:TextBox>
            <br />
        </div>
