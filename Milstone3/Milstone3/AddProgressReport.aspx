...
<body>
    <form id="form1" runat="server">
        ...
        <p>
            <asp:TextBox ID="reportNo" runat="server" required="required"></asp:TextBox>
        </p>
         <p>
            <asp:Label ID="Label1" runat="server" Text="Status"></asp:Label>
        </p>
        <p>
            <asp:TextBox ID="status" runat="server" required="required"></asp:TextBox>
        </p>
         <p>
            <asp:Label ID="Label2" runat="server" Text="Description"></asp:Label>
        </p>
        <p>
            <asp:TextBox ID="description" runat="server" Height="109px" Width="472px" required="required"></asp:TextBox>
        </p>
        <p >
