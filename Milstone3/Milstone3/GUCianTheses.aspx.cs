...
namespace Milstone3
{
    public partial class GUCianTheses : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ViewMyTheses.Parameters.Add(new SqlParameter("@studentId", id));
            conn.Open();
            GridView2.EmptyDataText = "No Records Found";
            GridView2.DataSource = ViewMyTheses.ExecuteReader();
            GridView2.DataBind();
            conn.Close();
        }
    }
