<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupervisorDefenseNonGUCian.aspx.cs" Inherits="Milstone3.SupervisorDefenseNonGUCian" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            Please Enter the data of the thesis's defense for NonGUCian
        </div>
        <p>
              Thesis Serial No</p>
